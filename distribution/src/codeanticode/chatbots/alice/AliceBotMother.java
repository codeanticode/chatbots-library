...
public class AliceBotMother
{
  ...
  */
  ...
  public AliceBot newInstance(String dir) throws Exception
  {
    Searcher searcher = new Searcher();
    AliceBotParser parser = new AliceBotParser();
    AliceBot bot = parser.parse(new FileInputStream(dir  + "/context.xml"),
                                new FileInputStream(dir  + "/splitters.xml"),
                                new FileInputStream(dir  + "/substitutions.xml"),
                                searcher.search(dir  + "/Alice", ".*\\.aiml"));

    Context context = bot.getContext(); 
    context.rootPath = dir;
